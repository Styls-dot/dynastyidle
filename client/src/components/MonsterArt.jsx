...
export function BambooSpriteSvg() {
  return (
...
export function PaleFoxSpiritSvg() {
  return (
...
export function HollowReedDemonSvg() {
  return (
...
export function GreenMistSpecterSvg() {
  return (
